  ...
  return (
    <>
      ...
      <LeadCaptureSection
        id="diagnostico"
        source="footer"
        headline="Quer uma operação que responda com previsibilidade?"
        description="Solicite diagnóstico estratégico. Você recebe rota de execução, padrão de captura e automações para reduzir perda de leads."
        intent="termos"
      />
    </>
  );
