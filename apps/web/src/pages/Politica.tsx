  ...
  return (
    <>
      ...
      <LeadCaptureSection
        id="diagnostico"
        source="footer"
        headline="Quer uma estrutura premium para capturar e responder?"
        description="Solicite diagnóstico estratégico. A ALTIQ organiza arquitetura, captura e automação para transformar presença em operação."
        intent="politica"
      />
    </>
  );
